            ...
            <tbody>
              {filterCurrentRowData.map((row, index) => (
                <tr key={row.id}>
                  ...
                  <td className="status-change">{showActive? <button className="pending-status"><MdDelete /> <br />INACTIVE</button>:<button className="active-status"><FaCheck/> <br />ACTIVE</button>}</td>
                </tr>
              ))}
            </tbody>
          </table>
